...
const Ebooks = () => {
  ...
  const goToEbookDetail = (row: EbookRow) => {
    const returnTo = `/admin/ebooks${buildEbooksListSearch()}`;
    sessionStorage.setItem(ADMIN_EBOOKS_LIST_RETURN_KEY, returnTo);
