    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <motion.div initial={false} animate={{ opacity: 1, y: 0 }}>
          <h2 className="text-2xl font-bold text-slate-800 dark:text-white">e-Books Management</h2>
          {/* <p className="text-sm text-slate-600 dark:text-slate-400">Digital titles — API ready.</p> */}
        </motion.div>
